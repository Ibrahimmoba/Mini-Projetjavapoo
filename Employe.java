...
class Salary {
    ...
    public static void main (String[] args) {
        ...
        p.ajouterEmploye(new Vendeur("Ndjilali", "Jules", 35, " 2006 ", 40000));
        p.ajouterEmploye(new Representant("Abdoulay", "Bobo", 29, "2010", 35000));
        p.ajouterEmploye(new Technicien("Tizi", "Samuel", 28, "2008", 2000));
        p.ajouterEmploye(new Manutentionnaire("Mohamadou", "Garba", 26, "2010", 50));
        p.ajouterEmploye(new TechnicienARisque("Maryam",  "Moahamadou", 25, "2009", 2000));
        p.ajouterEmploye(new ManutentionnaireARisque("Ali", "Adamou", 35, "2008", 50));
